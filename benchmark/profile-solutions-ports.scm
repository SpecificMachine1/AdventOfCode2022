(cond-expand
  (guile
    (import (scheme base)
            ...
            (prefix (ports day7) day7-) (prefix (ports day8) day8-) (prefix (ports day9) day9-)
            (benchmark profiler)))
  (else
    (import (scheme base)
            (scheme file)
            ...
            (prefix (ports 7) day7-) (prefix (ports 8) day8-) (prefix (ports 9) day9-)
            (benchmark profiler))))
(start-run)
(run "0.0 value" 3)
...
(run "9.1 tail visited: 2 segments" (day9-positions-visited 
                                      (day9-run-motions (day9-get-data "../data/day9-input.dat"))))
(run "9.1 tail visited: 10 segments" (day9-positions-visited
                                       (day9-run-motions* (day9-get-data "../data/day9-input.dat") 10)))
